export default function ContactPage() {
  return (
    <div className="min-h-screen">
      ...
      <div className="px-6 pb-24 md:px-[100px] grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
        <div>
          <h2 className="font-serif text-3xl font-black leading-[1.6] mb-5">
            声を
            <br />
            聞かせてください
          </h2>
          <p className="text-sm leading-[2] text-[var(--namanie-dim)] mb-9">
            寄稿、取材、あるいはただの感想でも。
            <br />
            煮え切らない言葉で構いません。
          </p>
          <a
            ...
            className="flex gap-4 items-center py-4 border-b border-[var(--namanie-border)] transition-pl duration-300 hover:pl-3"
          >
            <span className="w-8 h-8 border border-[rgba(185,28,28,0.2)] flex items-center justify-center text-xs text-[var(--namanie-red)] transition-colors duration-300 group-hover:bg-[var(--namanie-red)] group-hover:text-white">
              ✉
            </span>
            <div>
        ...
        <div>
          <div className="text-[10px] tracking-[3px] uppercase text-[var(--namanie-red)] mb-7">
            Message
          </div>
          <form
            action="#"
